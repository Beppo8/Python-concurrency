...
class Publisher(multiprocessing.Proccess):
    ...
    def run(self):
        ...
        logging.info('Conexion cerrada para publisher')

class Subscriber(multiprocessing.Proccess):
    def __init__(self, connection):
        self.is_alive = True
        self.connection = connection
        multiprocessing.Process.__init__(self)
    ...
    def run(self):
        ...
        while self.is_alive:
            ...
            self.connection.close()
            logging.info('Conexion cerrada para subscriber')
